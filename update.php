...
if (isset($_POST['Submit'])) {
    ...
    $status = $_POST['status'];
    $sql = "UPDATE task SET title='$title', description='$description', status='$status' WHERE id_task='$id_task'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    include 'koneksi.php';
                    $sql = mysqli_query($koneksi, "SELECT * FROM task WHERE id_task='$_GET[id_task]'");
